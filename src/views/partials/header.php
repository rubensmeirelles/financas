...
<head>
    ...
    <link rel="stylesheet" href="<?=$base;?>/assets/css/bootstrap.min.css" crossorigin="anonymous">
    ...
    <aside class="sidebar position-absolute d-flex flex-column top-0 text-white width-240">
        ...
        <div class="mt-2">
            <ul class="menu-item p-2">
                <a href="<?=$base;?>/index" class="text-decoration-none menu-list active">
                ...
                <a href="<?=$base;?>/lancamentos" class="text-decoration-none menu-list">
